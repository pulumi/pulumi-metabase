...
namespace Pulumi.Metabase
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Metabase.version.txt");
    ...
    internal sealed class MetabaseResourceTypeAttribute : Pulumi.ResourceTypeAttribute
    {
        public MetabaseResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
